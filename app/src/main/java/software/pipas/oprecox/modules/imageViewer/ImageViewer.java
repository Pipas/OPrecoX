...
public class ImageViewer extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
        {
            ...
            if (imagePreviewIndicator.getLayoutParams() instanceof ViewGroup.MarginLayoutParams) {
                ViewGroup.MarginLayoutParams p = (ViewGroup.MarginLayoutParams) imagePreviewIndicator.getLayoutParams();
                p.setMargins(0, p.topMargin + Util.getStatusBarHeight(getResources()), 0, 0);
                imagePreviewIndicator.requestLayout();
            }
        }
